...
public class ProfileAdapter extends ArrayAdapter<com.example.acer.currentlocation.Profile.locationView> {

        int resource;
        String response;
        Context context;
        private List<com.example.acer.currentlocation.Profile.locationView> items;
        private ProfileAdapter adapter;

public ProfileAdapter(Context context, int resource, List<com.example.acer.currentlocation.Profile.locationView> items) {
...
public View getView(int position, View convertView, ViewGroup parent) {
       ...
       final com.example.acer.currentlocation.Profile.locationView contact = getItem(position);
        if (convertView == null) {
