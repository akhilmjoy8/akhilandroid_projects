...
import com.example.acer.nsampledemo.Location.CameraUtils;
...
//                Toast.makeText(getApplicationContext(),"User  image capture", Toast.LENGTH_SHORT).show();
                ...
                Intent intent = new Intent(LocationHeadActivity.this, com.example.acer.nsampledemo.Location.LocationEntryActivity.class);
